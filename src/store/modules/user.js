...
const mutations = {
  ...
  SAVE_USER_INFO(state, userInfo) {
    ...
    state.userName = userInfo.adminUserName;
    state.userNickName = userInfo.adminUserName;
    state.avatar = userInfo.userAvatar;
    state.roleId = userInfo.roles[0].roleId;
    state.roles = userInfo.roles[0].permissions;
