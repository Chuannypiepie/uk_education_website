  ...
  <div class="main-container">
    ...
    <el-dialog :title="isNew ? '添加角色' : '编辑角色'" :visible.sync="dialogEditVisible">
      <el-form ref="baseForm" :model="menuModel" :rules="formRules" label-width="80px" label-position="right">
        ...
        <!-- <el-form-item label="显示状态" prop="path">
          <el-col :span="22">
            <el-select v-model="menuModel.isShow" size="small" placeholder="请输入菜单名称" style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    async getMenuList() {
      ...
      this.dataList = this.initMenuData(res.result);
    },
    /**
     * @method
